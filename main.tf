locals {
  ...
  */
  ...
  data = {
    ...
    "asia-east"        = "Hong Kong"            # East Asia
    "asia-pa"          = "Asia Pacific"         # Asia Pacific
    "asia-south-east"  = "Singapore"            # Southeast Asia
    "aus"              = "Australia"            # Australia
    ...
    "cn-east-2"        = "China"                # "China East 2"
    "cn-east-3"        = "China"                # "China East 3"
    "cn-east"          = "China"                # "China East"
    "cn-north-2"       = "China"                # "China North 2"
    "cn-north-3"       = "China"                # "China North 3"
    "cn-north"         = "China"                # "China North"
    "eu"               = "Europe"               # Europe
    "eu-north"         = "Ireland"              # North Europe
    "eu-west"          = "Netherlands"          # West Europe
    ...
    "isr-central"      = "Israel"               # Israel Central
    "ita-north"        = "Italy"                # Italy North
    ...
    "pol-central"      = "Poland"               # Poland Central
    "qat-central"      = "Qatar"                # Qatar Central
    "saf-north"        = "South Africa"         # South Africa North
    "saf-west"         = "South Africa"         # South Africa West
    "sgp"              = "Singapore"            # Singapore
    "swe"              = "Sweden"               # Sweden
    "swe-central"      = "Sweden"               # Sweden Central
    "swe-south"        = "Sweden"               # Sweden South
    "swz-north"        = "Switzerland"          # Switzerland North
    "swz-west"         = "Switzerland"          # Switzerland West
    "uae-central"      = "United Arab Emirates" # UAE Central
    "uae-north"        = "United Arab Emirates" # UAE North
    "uk-south"         = "United Kingdom"       # UK South
    "uk"               = "United Kingdom"       # UK
    "uk-west"          = "United Kingdom"       # UK West
